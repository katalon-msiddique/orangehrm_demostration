...
import com.kms.katalon.core.context.TestCaseContext
 ...
 /**
	 ...
	 */ 
def static "orangehrm.OrangeUtility.isTextEmpty"(
    	TestObject testObject	) {
    (new orangehrm.OrangeUtility()).isTextEmpty(
        	testObject)
}
 ...
 /**
	 ...
	 * @return boolean - true if the text matches, false otherwise
	 */ 
def static "orangehrm.OrangeUtility.validateText"(
    	TestObject testObject	
     , 	String expectedText	) {
    (new orangehrm.OrangeUtility()).validateText(
        	testObject
         , 	expectedText)
}
