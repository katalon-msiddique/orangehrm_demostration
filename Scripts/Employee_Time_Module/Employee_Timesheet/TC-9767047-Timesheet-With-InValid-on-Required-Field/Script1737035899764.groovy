...
Boolean companyTextEmpty = CustomKeywords.'orange.katalon.com.utilities.OrangeUtility.isTextEmpty'(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input'))
...
for (int i = 1; i <= 5; i++) {
    ...
    Boolean isHoursFilled = CustomKeywords.'orange.katalon.com.utilities.OrangeUtility.isTextEmpty'(inputBox)
