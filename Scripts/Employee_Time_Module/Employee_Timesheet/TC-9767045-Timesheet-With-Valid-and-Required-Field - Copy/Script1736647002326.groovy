...
WebUI.setText(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input_Exploratory Test Sessions_oxd-input o_4e3236'), 
    '8')

WebUI.setText(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input_Exploratory Test Sessions_oxd-input o_632308'), 
    '8')

WebUI.setText(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input_Exploratory Test Sessions_oxd-input o_632308_1'), 
    '8')

WebUI.setText(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input_Exploratory Test Sessions_oxd-input o_632308_1_2'), 
    '8')

WebUI.setText(findTestObject('Object Repository/Employee_Time_Module/Timesheet_Valid_Data/Page_OrangeHRM/input_Exploratory Test Sessions_oxd-input o_632308_1_2_3'), 
    '8')
