...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Profile_Photo_Upload_Objects/Page_OrangeHRM/input_Username_username'), 'mahtab')

// Enter the password
WebUI.comment('Entering the password.')
WebUI.setEncryptedText(findTestObject('Object Repository/Employee-Onboarding/Employee_Profile_Photo_Upload_Objects/Page_OrangeHRM/input_Password_password'), 'p7egalF197zCPQnMaznrNq5yBULcTkKN')
...
WebUI.setText(findTestObject('Object Repository/Employee-Onboarding/Employee_Profile_Photo_Upload_Objects/Page_OrangeHRM/input'), 'Sandra Barber')
...
if (Employee_Gender == 'Male') {
	...
	filePath = '/Users/mahtabsiddique/Documents/avatar/woman.jpg' // Replace with the actual file path
}

// Upload the photo file
WebUI.comment('Uploading the profile photo file.')
WebUI.uploadFile(findTestObject('Object Repository/Employee-Onboarding/Employee_Profile_Photo_Upload_Objects/Page_OrangeHRM/file_input_locator'), filePath)
